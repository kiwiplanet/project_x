            ...
            @foreach ($results as $result)
                <div class="col mb-4">
                    <div class="card card-sm" style="width: 85%;">
                        ...
                        @endif
                        <img src="{{ Storage::disk('s3')->url($result->img_path) }}" class="card-img-top" alt="{{ $result->name }}">
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item {{ $result->total_stock < $result->regular_stock ? 'yellow-background' : '' }}">
                                総在庫数：{{ $result->total_stock }}</li>
